...
- 《中兴微方案常用指令集V1.0》- 谭健伟 —— 中兴微平台 shell 命令速查（13 组内总结）
- 《联通智能相关命令》- 周鹏 —— 联通平台设备命令集（006/网关/45）
- 《DBUS接口命令集》- 徐雄 —— 电信 DBUS 接口命令（006/网关/43）
- 《OSGITest工具命令集》- 徐惠恩 —— OSGI 插件测试命令（006/网关/51）
- 《Ubuntu下使用Kea搭建DHCP服务器》《Ubuntu下搭建Speedtest测速服务器》- 徐惠恩 —— Linux 服务器搭建（006/网关/57、58）
